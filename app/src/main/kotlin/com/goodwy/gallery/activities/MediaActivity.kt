    ...
    private fun checkLastMediaChanged() {
        ...
        mLastMediaHandler.postDelayed({
            ensureBackgroundThread {
                ...
                val changed = mLatestMediaId != mediaId || mLatestMediaDateId != mediaDateId
                App.logGesture("checkLastMediaChanged path=%s prevId=%d newId=%d prevDateId=%d newDateId=%d changed=%b".format(mPath, mLatestMediaId, mediaId, mLatestMediaDateId, mediaDateId, changed))
                if (changed) {
